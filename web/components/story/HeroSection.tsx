...
export function HeroSection({ totalAudits, uniqueModels }: HeroSectionProps) {
    ...
    return (
        <section
            ref={ref}
            className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-indigo-900 flex items-center justify-center text-white relative overflow-hidden"
        >
          ...
          `,
            ...
            <div className="relative z-10 text-center max-w-5xl px-8">
                ...
                >
                    ...
                    <br />
                    <span className="text-indigo-300">for Content Moderation Bias</span>
                </motion.h1>
                ...
                <motion.div
                    ...
                    className="my-16"
                >
                    <div className="text-8xl md:text-9xl lg:text-[12rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
